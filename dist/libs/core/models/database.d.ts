...
import { PebPageShort, PebShopThemeId, PebShopThemeSnapshotId, PebShopThemeSourceId, PebShopThemeVersionId } from './editor';
...
export declare type PebPageEntity = PebPage;
